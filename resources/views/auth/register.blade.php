<x-guest-layout>
    <div class="flex items-center bg-green-500 text-white text-sm font-bold px-4 justify-center py-3" role="alert">
        ...
        <p>Molimo Vas da popunite sva polja. Ukoliko ne unesete ispravne podatke, račun vam neće biti odobren od strane administratora. Sva polja sa ( * ) su obavezni</p>
    </div>
