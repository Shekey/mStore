        ...
        <div class="relative flex sm:items-center justify-center min-h-screen sm:pt-0" style="background-image: url('/assets/404.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center sm:justify-center sm:pt-0" style="flex-wrap: wrap">
                    ...
                    <div class="ml-4 text-xl font-semibold text-amber-600 uppercase tracking-wider mb-4">
                        <h2>
                            @yield('message')
                        </h2>
                    </div>

                    <div style="flex-basis: 100%; display: flex; justify-content: center; margin-top: 15px;">
                        <a href="{{ url()->previous() }}" style="border: 1px solid black; padding: 15px; border-radius: 15px; font-weight: 900;">Vratite se na prethodnu stranicu.</a>
                    </div>
                </div>
            </div>
        </div>
