        ...
        <header>
            ...
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
                <svg class="h-5 w-5 text-white" viewBox="0 0 24 24" fill="none">
                    ...
                    <input class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" wire:model.debounce.250ms="search" placeholder="Pretraga po nazivu artikla">
                </div>
            </div>
        </header>
        ...
        <div class="container">
            ...
            @foreach($articles as $article)
                    ...
                    <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('https://images.unsplash.com/photo-1495856458515-0637185db551?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80')">
                        <button class="p-2 rounded-full bg-orange-600 text-white mx-5 -mb-4 hover:bg-orange-600 focus:outline-none focus:bg-blue-500" wire:click="addToCart({{ $article->id }})">
