<section class="text-black body-font flex flex-col lg:w-1/3 mb-8 px-4 relative fade fadeOut">
    <div class="container mx-auto flex flex-wrap px-0 py-4 flex-col justify-center">
